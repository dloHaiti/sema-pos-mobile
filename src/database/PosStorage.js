...
class PosStorage {
	constructor() {
		...
		this.settings = { semaUrl: process.env.NODE_ENV === 'production' ? "http://dlo.semawater.org" : "http://10.0.3.2:3001", site: "", user: "", password: "", uiLanguage: { name: 'Français', iso_code: 'fr' }, token: "", siteId: "" };
		this.salesChannels = [];
		this.customerTypes = [];
		this.receipts = [];
		this.productMrpDict = {};
